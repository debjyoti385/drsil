...
class ctGalleryTypeBase extends ctTypeBase {
	...
	protected function registerType() {
		$typeData = $this->callFilter('pre_register_type', array(
			'labels' => array(
				...
				'add_new_item' => __('Add New Gallery Item', 'ct_theme'),
				'edit_item' => __('Edit Gallery Item', 'ct_theme'),
				'new_item' => __('New Gallery Item', 'ct_theme'),
				'view_item' => __('View Gallery Item', 'ct_theme'),
				'search_items' => __('Search Gallery Items', 'ct_theme'),
				'not_found' => __('No gallery item found', 'ct_theme'),
				'not_found_in_trash' => __('No gallery items found in Trash', 'ct_theme'),
				'parent_item_colon' => '',
				'menu_name' => __('Gallery items', 'ct_theme'),
			),
	...
	protected function getPermalinkSlug() {
		...
		$permalink_slug = ct_get_option('gallery_index_slug', 'gallery');
