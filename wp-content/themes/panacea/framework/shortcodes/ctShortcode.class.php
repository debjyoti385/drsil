...
abstract class ctShortcode {
	...
	public function getAttributesNormalized() {
		...
		return apply_filters(self::getFilterName($this->getShortcodeName(), self::FILTER_NORMALIZED_ATTRIBUTES), $attr);
	}
	...
	public static function connectNormalizedAttributesFilter($shortcodeName, $callback) {
		add_filter(self::getFilterName($shortcodeName, self::FILTER_NORMALIZED_ATTRIBUTES), $callback);
	}
