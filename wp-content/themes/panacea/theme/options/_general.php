...
$sections[] = array(
	...
	'fields' => array(
        ...
        array(
            'id' => 'general_show_contact_bar',
            'title' => __("Show contact bar?", 'ct_theme'),
            'type' => 'select_show',
            'std' => 1
        ), array(
            'id' => 'general_contact_bar_phone',
            'type' => 'text',
            'title' => __('Phone number', 'ct_theme'),
            'desc' => __("You can enter phone number which will be displayed above the menu bar", 'ct_theme'),
            'std' => ""
        ), array(
            'id' => 'general_contact_bar_email',
            'type' => 'text',
            'title' => __('E-mail address', 'ct_theme'),
            'desc' => __("You can enter e-mail address which will be displayed above the menu bar", 'ct_theme'),
            'std' => ""
        ),
