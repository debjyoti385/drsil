...
$theme_info .= '<p class="ct_theme-theme-data description theme-uri">' . __('<strong>Support forum:</strong> ', 'ct_theme') . '<a href="http://support.createit.pl" target="_blank">http://support.createit.pl</a></p>';
...
$args['share_icons']['logo'] = array(
	'link' => ' http://themeforest.net/user/ThemePlayers/portfolio?ref=ThemePlayers',
	'title' => __('Browse our portfolio', 'ct_theme'),
	'img' => CT_THEME_SETTINGS_MAIN_DIR_URI . '/img/tp-logo.png'
);
